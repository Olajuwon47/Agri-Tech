  ...
  return (
    <div className="py-16 bg-gradient-to-b from-emerald-50 via-white to-green-50 px-4 max-sm:px-3">
          ...
          <CarouselContent className="max-sm:-ml-2 max-md:-ml-4">
            {testimonials.map((t, i) => {
              ...
              return (
                <CarouselItem
                  key={i}
                  className="pl-4 md:pl-6 max-sm:pl-2 max-md:pl-4 max-sm:basis-full max-md:basis-1/2 lg:basis-1/3"
                >
                  <motion.div
                    ref={ref}
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex mt-1">
                          {[...Array(5)].map((_, j) => (
                            <span
                              key={j}
                              className="text-yellow-400 text-sm max-sm:text-xs"
                            >
                              ★
                            </span>
                          ))}
      ...
      >
        ...
        <a href="/Community" className="bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-4 rounded-full transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-md max-sm:py-2 max-sm:px-6 max-sm:text-sm">
